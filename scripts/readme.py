...
class Config:
    local_path = '/Users/mj/Documents/leetcode'
    # solution of leetcode
    github_leetcode_url = 'https://github.com/mingjie-wang/leetcode/'
    # solution of pat
...
class Readme:
    ...
    def __init__(self, total, solved, locked, others=None):
        ...
        :param others: for later extensions
        """
        self.total = total
        self.solved = solved
        self.others = others
